...
public class App {
    public static void main(String[] args) throws Exception {
       ...
       iMachine.addProduct(new Bottle(4, "Water", "Water", 170, 100));
       iMachine.addProduct(new HotDrink(5, "HotWater", "HotWater", 170, 100, 50));
       iMachine.addProduct(new HotDrink(6, "HotWater", "CoolWater", 170, 100, 25));
